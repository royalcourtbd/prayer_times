...
class GetEventsUseCase extends BaseUseCase<List<EventEntity>> {
  ...
  GetEventsUseCase(this._repository, ErrorMessageHandler errorMessageHandler)
  ...
  Future<Either<String, List<EventEntity>>> execute({
    ...
    return mapResultToEither(() async {
      final Either<String, List<EventEntity>> result = await _repository
          .getEvents(forceRefresh: forceRefresh);
