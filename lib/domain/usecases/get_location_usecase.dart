...
class GetLocationUseCase extends BaseUseCase<LocationEntity> {
  ...
  GetLocationUseCase(this._repository, ErrorMessageHandler errorMessageHandler)
  ...
  Future<Either<String, LocationEntity>> execute({
    ...
    return mapResultToEither(() async {
      final Either<String, LocationEntity> result = await _repository
          .getLocation(forceRemote: forceRemote);
