    ...
    return PresentableWidgetBuilder(
      ...
      builder: () {
        return CustomModalSheet(
          theme: theme,
          bottomSheetTitle: isCountrySelection
              ? 'Select Country'
              : 'Select City',
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final CountryNameEntity country =
                              settingsPresenter.currentUiState.countries[index];
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                trailing:
                                    ...
                                    : null,
                                onTap: () {
                                  settingsPresenter.onCitySelected(city: city);
                                  context.navigatorPop();
                                },
                              );
                            },
