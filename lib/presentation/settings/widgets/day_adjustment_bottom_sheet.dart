...
class DayAdjustmentBottomSheet extends StatelessWidget {
  ...
  static const List<int> _adjustmentValues = [-3, -2, -1, 0, 1, 2, 3];
        ...
        return CustomModalSheet(
          ...
          children: [
            ...
            Row(
              ...
              children: _adjustmentValues.map((value) {
                final isSelected =
  ...
  Widget _buildChip({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        padding: EdgeInsets.symmetric(horizontal: twelvePx, vertical: tenPx),
