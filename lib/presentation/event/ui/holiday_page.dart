              ...
              children: [
                Padding(
                  ...
                  child: UserInputField(
                    textEditingController: eventPresenter.searchController,
                ...
                Expanded(
                  child: HolidayListView(
                    groupedEvents: eventPresenter.currentUiState.groupedEvents,
                    theme: theme,
...
class HolidayListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (groupedEvents.isEmpty) {
      return const Center(child: Text('No Event\'s Found'));
    }
...
class MonthEventsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        MonthHeader(month: month, theme: theme),
        ListView.builder(
...
class MonthHeader extends StatelessWidget {
  const MonthHeader({super.key, required this.month, required this.theme});
