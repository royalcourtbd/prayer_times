  ...
  Widget build(BuildContext context) {
    ...
    return PresentableWidgetBuilder(
      ...
      builder: () {
        ...
        final bool hasActiveBankPayment = uiState.bankPayments.any(
          (bankPayment) => bankPayment.isActive == true,
        );
        final bool hasActiveMobilePayment = uiState.mobilePayments.any(
          (mobilePayment) => mobilePayment.isActive == true,
        );

        return Scaffold(
          appBar: CustomAppBar(title: 'Support Us', theme: theme),
