...
class PaymentIconRow extends StatelessWidget {
  ...
  const PaymentIconRow({super.key, required this.mobilePaymentEntity});

  @override
  Widget build(BuildContext context) {
    final paymentMethod = PaymentMethod.fromBankName(
    ...
    return Row(
      ...
      children: [
        ...
        SvgImage(SvgPath.icCopy, color: mobilePaymentEntity.cardColor),
      ],
    );
  }
}
